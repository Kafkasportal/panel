    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-[[data-collapsible=icon]]:flex-col",
            className
          )}
          ref={ref}
          {...props}
      ...
      <>
        ...
        >
          <div
            ...
            className={cn(
              "duration-200 ease-linear",
              "flex h-full max-h-screen flex-col border-r",
              "group-data-[collapsible=icon]/sidebar-wrapper:w-[--sidebar-width-icon]",
              variant === "floating" && "border-0 p-2",
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-50 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-full after:-translate-x-1/2 group-data-[side=left]/sidebar-wrapper:-left-4 group-data-[side=right]/sidebar-wrapper:-right-4 hover:bg-sidebar-accent",
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "peer-data-[variant=inset]/sidebar:min-h-[calc(100svh-theme(spacing.4))] peer-data-[variant=inset]/sidebar:rounded-md peer-data-[variant=inset]/sidebar:border",
          className
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => {
  return (
    <input
      ...
      data-sidebar="input"
      className={cn(
        "flex h-8 w-full rounded-md border border-sidebar-border bg-sidebar-accent px-3 py-1 text-sm text-sidebar-foreground ring-sidebar-ring transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-sidebar-foreground/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-2 focus-visible:ring-offset-sidebar disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn("ml-auto flex h-5 min-w-5 items-center justify-center rounded-md px-1.5 text-xs font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none", className)}
        {...props}
      />
    )
  }
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="h-4 max-w-[--skeleton-width] flex-1 animate-pulse rounded-md bg-sidebar-primary/10"
        style={
          {
