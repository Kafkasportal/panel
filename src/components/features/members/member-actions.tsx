      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            size="icon"
            className="h-8 w-8"
            aria-label={`${member.ad} ${member.soyad} için işlemler menüsü`}
          >
          ...
          <DropdownMenuItem
            onClick={() =>
              window.dispatchEvent(
                new CustomEvent("edit-member", { detail: member }),
              )
            }
          >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              adlı üyeyi silmek istediğinizden emin misiniz? Bu işlem geri
              alınamaz.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
