...
export function useAuditLogs(
  params?: Parameters<typeof service.fetchAuditLogs>[0],
  options?: Omit<
  ...
  return useQuery({
    ...
    queryFn: () => service.fetchAuditLogs(params || {}),
    ...options,
  });
}
...
export function useAuditLog(
  id: string,
  options?: Omit<
    UseQueryOptions<Awaited<ReturnType<typeof service.fetchAuditLog>>>,
    "queryKey" | "queryFn"
  >,
) {
  return useQuery({
    queryKey: queryKeys.auditLogs.detail(id),
    queryFn: () => service.fetchAuditLog(id),
    enabled: !!id,
    ...options,
  });
}
